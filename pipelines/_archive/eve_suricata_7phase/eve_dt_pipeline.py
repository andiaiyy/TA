"""
Decision Tree pipeline for EVE/Suricata dataset.

Runs phases 1-9 (shared preprocessing via phase_runner) then trains a DT
on the Phase-9 RFE-selected features.
"""
...
class EVEDTPipeline(BasePipeline):
    ...
    def get_info(self) -> dict:
        return {
            ...
            "fixed_params": {"random_state": 42, "feature_method": "RFE"},
