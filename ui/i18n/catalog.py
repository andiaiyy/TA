...
CATALOG: dict[str, dict[str, str]] = {
    ...
    "rs.warn_contract": {"id": "Bagian ini menentukan bagaimana berkas dataset DIPERIKSA. Mengubahnya berlaku untuk pemeriksaan berikutnya — eksperimen yang sudah berjalan tetap tercatat dengan kontrak yang berlaku saat itu.",
                         "en": "This section decides how dataset files are CHECKED. Changing it applies to later checks — experiments already run keep the contract that applied at the time."},
    ...
    "rs.help_expected_columns": {"id": "Satu nama kolom per baris. Kosong berarti tidak ada kolom yang diwajibkan.",
                                 "en": "One column name per line. Empty means no column is required."},
